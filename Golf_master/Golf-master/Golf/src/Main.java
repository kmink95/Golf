...
class var_setting {
	...
	//80min
	static int shorter_time_limit = 80;
	//100min
	static int longer_time_limit = 100;
	//15:00
	static int weekday_time_limit_shorter_started_time = 15;
}
...
class ask_box {
	...
	public ask_box() {
		if (JOptionPane.showConfirmDialog(null, "¿À´ÃÀÌ °øÈÞÀÏ ÀÔ´Ï±î?", "", JOptionPane.YES_NO_OPTION) == 0)
			isIt = 1;
		else
			isIt = 0;
	}
...
class main_Frame {
	private JFrame f = new JFrame("»ð±³ÄÝÇÁÅ¬·´");
